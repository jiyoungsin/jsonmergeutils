...
class Merge:
    ...
    def merge(self):
        ...
        the_done_message = 'Done!!'
        the_message = '{} Files Processed'.format(count)
        the_files_created = '{} Result files created'.format(self.counter)
        logger.info(the_done_message)
        logger.info(the_message)
        logger.info(the_files_created)
